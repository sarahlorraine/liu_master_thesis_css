...
# Select just the "highway" and "junction" values of the osmlines as the rest are not needed for the network
...
p2p.data <- p2p.data %>% mutate(full_address = gsub(" , ", "", paste(ifelse(is.na(address$street), name, address$street), 
                                         address$city, 
                                         address$subdivision)))
# Generate the charge point details url
