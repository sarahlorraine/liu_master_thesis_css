...
### Enviro Setup
setwd("C:/Users/snewt/Desktop/Thesis")

#### Google Places API key
key <- "AIzaSyBayjlO6MsVNzYeuRqkiLADgXQrLGIRf9g"
```
...
nodes.averages <- merge(nodes.averages, negative_exp, by.x="nodeID", by.y="id", all=FALSE) %>%
