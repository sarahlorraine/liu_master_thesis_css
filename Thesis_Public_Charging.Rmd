...
distance_travel_matrix <- path_graph %>% activate(nodes) %>% 
  as_data_frame() %>% 
...
model1 <- lm(avg_dist~foreign+nodes+äganderätt+total_households+avg_dd_accessibility, 
