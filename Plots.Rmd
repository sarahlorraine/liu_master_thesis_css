...
R code to product the plots and tables used in the thesis

Note: Run Thesis_Public_Charging.Rmd first
...
```{r example_graph}
# Generate a simple graph network to product plots as examples for the network subdivision 
#l1
p1 <- st_point(c(0, 1))#
p2 <- st_point(c(2, 1))
