...
ggplot() +
  #geom_sf(data=gothenburg.subdiv) +
  geom_sf(data = got.boundary$osm_multipolygons, linewidth=0.5, colour="grey") +
  geom_sf(data=gothenburg.subdiv.merged, alpha=0.7, aes(fill=log10(avg_dijk_dist)), linewidth=0.8) +
  #geom_sf(data = streets$osm_lines, linewidth=0.2, color = 'black') +
  coord_sf(xlim = c(11.71, 12.16), 
           ylim = c(57.57, 57.86), expand = TRUE, clip = "on") +
  labs(title="Average distance to public charging point in Gothenburg",
       ...
       fill = "Distance") +
  scale_fill_gradientn(colors = wes_palette(n=7, name = "Zissou1", type = "continuous"),
                       limits= c(0, max(log10(gothenburg.subdiv.merged$avg_dijk_dist)))) +
  theme_custom
```
...
ggplot() +
  ...
  geom_sf(data=got.sub.new.rentals, alpha=0.7, aes(fill=(avg_dijk_dist)), linewidth=0.8) +
  #geom_sf(data = streets$osm_lines, linewidth=0.2, color = 'black') +
  coord_sf(xlim = c(11.71, 12.16), 
           ylim = c(57.57, 57.86), expand = TRUE, clip = "on") +
  labs(title="Average distance to public charging point in Gothenburg",
       ...
       fill = "Distance") +
  scale_fill_gradientn(colors = wes_palette(n=7, name = "Zissou1", type = "continuous"),
                       limits= c(0, max((gothenburg.subdiv.merged$avg_dijk_dist)))) +
  theme_custom
```
...
ggplot() +
  #geom_sf(data=gothenburg.subdiv) +
  geom_sf(data=gothenburg.subdiv.merged, alpha=0.9, linewidth=0.6) +
  geom_sf(data=got.sub.new.owner.occupied, alpha=0.7, aes(fill=(avg_dijk_dist)), linewidth=0.8) +
  #geom_sf(data = streets$osm_lines, linewidth=0.2, color = 'black') +
  coord_sf(xlim = c(11.71, 12.16), 
           ylim = c(57.57, 57.86), expand = TRUE, clip = "on") +
  labs(title="Average distance to public charging point in Gothenburg",
